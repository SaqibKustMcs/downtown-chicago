...
class _ProfileScreenState extends State<ProfileScreen> {
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    // Admin Hub - Only show for admin users
                    if (currentUser?.userType == UserType.admin) ...[
                      _buildMenuGroup(context, [
                        _buildMenuItem(
                          ...
                          title: 'Admin Hub',
                          onTap: () {
                            Navigator.pushNamed(context, Routes.adminHub);
                          },
                        ),
                      ]),
                    ...
                    _buildMenuGroup(context, [
                      ...
                      _buildMenuItem(context: context, icon: TablerIconsHelper.location, iconColor: Colors.blue, title: 'Addresses', onTap: () {}),
                    ]),
                    ...
                    RepaintBoundary(
                      child: _buildMenuGroup(context, [
                        ...
                        _buildMenuItem(context: context, icon: TablerIconsHelper.star, iconColor: Colors.teal, title: 'User Reviews', onTap: () {}),
                        _buildMenuItem(
                          context: context,
                        ...
                        _buildMenuItem(context: context, icon: TablerIconsHelper.settings, iconColor: Colors.purple, title: 'Settings', onTap: () {}),
  ...
  Future<void> _handleLogout(BuildContext context) async {
    ...
    unawaited(FirebaseService.auth.signOut().catchError((e) {
      debugPrint('Firebase signOut error: $e');
    }));
    
    // Step 3: Remove FCM token for this device
    unawaited(PushNotificationService.instance.removeTokenByDeviceId().catchError((e) {
    ...
    unawaited(_clearLocalStorageSilently().catchError((e) {
  ...
  Future<void> _clearLocalStorageSilently() async {
    try {
      ...
      await Future.wait([
        SecureStorageService.delete('current_user'),
